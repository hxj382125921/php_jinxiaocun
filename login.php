...
<table width="830" height="161" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="161" align="center"><img src="images/logo.gif" /></td>
  </tr>
</table>
	...
	<form id="form1" name="form1" method="post" action="logincheck.php" onsubmit="return fLoginFormSubmit();">
      <table width="100%" height="233" border="0" cellpadding="0" cellspacing="1">
        ...
        <tr>
          ...
          <td><input type="text" style="width:160px;" class="border" name="username" onFocus="fEvent('focus',this)" onBlur="fEvent('blur',this)" onMouseOver="fEvent('mouseover',this)" onMouseOut="fEvent('mouseout',this)" maxlength="10" /></td>
        </tr>
        <tr>
          <td height="40" align="right">密&nbsp;码：&nbsp;</td>
          <td><input type="password" name="password" style="width:160px;" class="border" onFocus="fEvent('focus',this)" onBlur="fEvent('blur',this)" onMouseOver="fEvent('mouseover',this)" onMouseOut="fEvent('mouseout',this)" /></td>
        </tr>
        <tr>
          <td height="40" align="right">验证码：&nbsp;</td>
          <td><table width="160" height="24" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="96"><input type="text" name="imgpost" style="width:80px;" class="border" onFocus="fEvent('focus',this)" onBlur="fEvent('blur',this)" onMouseOver="fEvent('mouseover',this)" onMouseOut="fEvent('mouseout',this)" maxlength="50" /></td>
...
<table width="830" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="40" align="center">技术支持QQ382125921 &nbsp;&nbsp;&nbsp; V1.0</td>
  </tr>
</table>
</body>
</html>
